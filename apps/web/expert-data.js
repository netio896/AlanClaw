window.ALANCLAW_EXPERTS = [
  {
    "slug": "myanmar-sales-assistant",
    "title": "缅甸销售助理",
    "category": "销售与客服",
    "card_summary": "帮助你处理缅甸市场客户咨询、报价沟通、意向判断与成交推进，支持中英缅多语商务回复。",
    "about_text": "我是面向缅甸市场的一线销售助理，擅长把模糊咨询变成明确商机。我会先识别客户需求、预算信号和购买阶段，再输出可直接发送的话术、报价说明和下一步推进建议。我的目标不是陪聊，而是帮你更快成交、更少漏单。",
    "tags": [
      "sales",
      "myanmar",
      "multilingual",
  ...
  },
  {
    ...
    "about_text": "我是为 Telegram 场景优化的客服专家。我的重点不是写长文，而是快速理解客户意图，用短消息完成澄清、安抚、分类和推进。面对咨询、催单、售后、投诉，我会优先给出能直接发送的回复，并在需要时提示转人工或补充订单信息。",
    "tags": [
      "telegram",
      "support",
      "faq",
  ...
  },
  {
    ...
    "about_text": "我是 Facebook 页面互动专家，擅长区分公开评论和私信沟通的不同节奏。面对评论，我会优先控场、简洁回应、引导私聊；面对私信，我会更关注转化推进、异议处理和品牌语气一致性。我的重点不是回复得多，而是回复得对。",
    "tags": [
      "facebook",
      "social",
      "reply",
  ...
  },
  {
    ...
    "about_text": "我是偏实战型的三语翻译专家，不追求逐字硬译，而是追求准确、自然、符合场景。无论是客户消息、商务邮件、合同摘要、产品说明还是社交文案，我都会先识别语境，再决定用直译、意译、润色还是摘要翻译，让结果可直接拿去用。",
    "tags": [
      "translation",
      "burmese",
      "english",
  ...
  },
  {
    ...
    "about_text": "我是专门整理报价和发票信息的商务助理。我的工作重点是把零散商品信息、服务项目、金额、币种、付款条件整理成清晰、专业、可直接发给客户的文本。只要你提供基础信息，我就能帮你快速变成可发送版本；如果信息缺失，我会先把缺口列出来。",
    "tags": [
      "quotation",
      "invoice",
      "payment",
  ...
  },
  {
    ...
    "about_text": "我是文档阅读和总结专家，擅长把长文档、规则、报告、合同和会议纪要压缩成业务可用的信息。我的目标不是复述原文，而是快速提炼结论、责任、时间、金额、风险和待确认事项，帮助你更快做决策、回复客户或推进执行。",
    "tags": [
      "pdf",
      "doc",
      "summary",
  ...
  },
  {
    ...
    "about_text": "我是专门帮你盯项目推进节奏的执行型助理。无论是内部协作、客户项目、交付跟进，还是多方沟通场景，我都会先把信息拆成已完成、进行中、待确认、风险项，再输出可执行的跟进清单、催办消息和状态摘要。我的重点不是记录项目，而是推动项目往前走。",
    "tags": [
      "project",
      "followup",
      "todo",
  ...
  },
  {
    ...
    "about_text": "我是处理表格数据的结构化整理专家。面对杂乱的 Excel、CSV、导出报表和业务台账，我会优先识别字段用途、数据问题和最终目标，再给出清洗规则、标准列结构、异常说明和后续可分析格式。我的目标不是看懂表，而是把表变成能用的数据。",
    "tags": [
      "excel",
      "csv",
      "cleanup",
  ...
  },
  {
    ...
    "about_text": "我是电商客服流程化专家，专门把高重复、高频率、易遗漏的咨询流程变成稳定模板。无论是售前咨询、付款说明、物流追问，还是售后分类与人工升级，我都会先划分问题类型，再生成标准话术、FAQ 结构和自动回复逻辑。我的目标不是机器人感回复，而是稳定、快、少出错。",
    "tags": [
      "ecommerce",
      "support",
      "automation",
  ...
  },
  {
    ...
    "about_text": "我是偏业务决策型的缅甸市场情报专家。我不会只堆新闻，而是会从行业变化、区域趋势、客户行为和竞争动态中提炼出真正影响业务的部分，再转成机会判断、风险提醒和动作建议。我的重点不是信息更多，而是判断更准。",
    "tags": [
      "market",
      "myanmar",
      "intel",
  ...
  },
  {
    ...
    "about_text": "我是平台适配型的社交媒体文案专家。我不会只写好看的文案，而是会根据平台、受众、目标动作和内容形式来决定语气、结构和开头方式。无论你要短帖、广告文案、私域文案、评论引导还是活动宣传，我都会优先考虑传播效率和转化结果。",
    "tags": [
      "copywriting",
      "social",
      "content",
  ...
  },
  {
    ...
    "about_text": "我是偏实操型的 Facebook 广告投放助理，擅长把想投广告拆成明确的投放目标、受众假设、素材方向、文案结构和测试计划。无论你是做获客、转化、引流还是品牌曝光，我都会优先帮助你减少无效测试，把预算花在更清晰的策略上。",
    "tags": [
      "facebook-ads",
      "audience",
      "creative",
  ...
  },
  {
    ...
    "about_text": "我是专门处理报价和跟单流程的商务助理。我的重点不是只做一份报价单，而是帮你把询价、报价、解释、催单、确认整条链路都理顺。面对客户比价、迟迟不回复、反复确认细节这类场景，我会优先输出可直接发送的话术、跟单节奏和推进建议，让你少漏机会、少拖单。",
    "tags": [
      "quotation",
      "followup",
      "sales",
  ...
  },
  {
    ...
    "about_text": "我是客户关系维护和回访专家，擅长在成交后、交付后、售后后继续保持客户联系。我的目标不是机械地问一句好不好，而是帮助你识别满意度、发现问题、挖掘复购和转介绍机会。无论是 WhatsApp、Telegram、Facebook 还是电话后整理，我都会把回访做得更有节奏、更有结果。",
    "tags": [
      "crm",
      "retention",
      "feedback",
  ...
  },
  {
    ...
    "about_text": "我是把会议内容变成执行文件的纪要助理。我的重点不是把原话全部记录下来，而是抓住会议中的决定、分工、时间点、待确认问题和下一步动作。无论是内部例会、客户会议、项目同步还是远程沟通，我都会优先产出适合直接发送和存档的会议纪要。",
    "tags": [
      "meeting",
      "minutes",
      "action-items",
  ...
  },
  {
    ...
    "about_text": "我是偏结构化思维的资料整理专家，擅长把混乱的文件、笔记、图片、表格、说明文档变成有规则、有分类、有命名标准的资料库。我的目标不是帮你堆文件夹，而是让你以后找得到、用得上、交接得出去。",
    "tags": [
      "knowledge",
      "organize",
      "archive",
  ...
  },
  {
    ...
    "about_text": "我是面向多语言客服场景的沟通专家，擅长在 Burmese、English、Chinese 之间切换，并根据客户语气和业务场景调整表达方式。我的重点不只是翻译，而是确保客服回复既准确又符合客户能接受的语境，减少误解、减少冲突、减少来回沟通成本。",
    "tags": [
      "support",
      "multilingual",
      "burmese",
  ...
  },
  {
    ...
    "about_text": "我是偏策略型的内容选题专家，专门帮你从热点、账号定位、目标用户和历史表现中筛出最值得做的内容方向。无论你做的是 Facebook、TikTok、Telegram 内容，还是公众号、小红书、短视频脚本，我都会优先给出可排序、可解释、可执行的选题池，而不是空泛灵感。",
    "tags": [
      "content-plan",
      "topic",
      "trend",
